...
import "./VerbalTest.css";  // reuse existing CSS
import "../Shortlistingtest/Testpage.css";
...
export default function VerbalTest() {
    ...
    const startTest = async () => {
        await fetch(`${API}/comm-test/${token}/start`, { method: "POST" });
        setTimeLeft(test.duration_mins * 60);
        setAnswers(new Array(test.total_questions).fill(null));
        setPhase("test");
    };
    ...
    const nextQuestion = () => {
        ...
        setAnswers(updated);
        setSelected(null);
        if (current < test.total_questions - 1) setCurrent(c => c + 1);
    ...
    const handleSubmit = async (finalAnswers) => {
        ...
        try {
            const res = await fetch(`${API}/comm-test/${token}/submit`, {
                method: "POST",
        ...
        <div className="tp-split">
            ...
            <div className="tp-right">
                <div className="tp-right-centered">
                    ...
                    <p className="tp-caption">Loading verbal test…</p>
                </div>
            </div>
        </div>
    );
        ...
        <div className="tp-split">
            ...
            <div className="tp-right">
                <div className="tp-right-centered">
                    ...
                    <p className="tp-caption">Invalid or already used test link.</p>
                </div>
            </div>
        </div>
    );
    ...
    if (phase === "result") return (
        <>
            <div className="tp-split">
                ...
                <div className="tp-right">
                    <div className="tp-right-centered">
                        <p className="tp-eyebrow">Hiresy · Verbal Ability</p>
                        <p className="tp-display">Test Submitted</p>
                        <p className="tp-body" style={{ maxWidth: 320, fontSize: 'medium' }}>
                            Your responses have been recorded. You will be notified by email if you are selected for the next round.
                        </p>
            ...
            {showDone && (
                <div className="tp-overlay" onClick={() => setShowDone(false)}>
                    <div className="tp-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <p className="tp-modal-body">Thank you for completing the verbal ability test.</p>
            ...
            <div className="tp-right">
                <div className="tp-intro-inner">
                    <div className="tp-flex-col tp-gap-1">
                        <p className="tp-eyebrow">Hiresy · Verbal Ability Test</p>
                        <p className="tp-display">{test.job_title}</p>
                        <p className="tp-body">Hi <span style={{ fontWeight: 600 }}>{test.candidate_name}</span>, test your verbal skills.</p>
                    </div>
            ...
            <div className="tp-right tp-question-right">
                <div className="tp-q-header">
                    ...
                    <div className="tp-q-tags">
                        <span className="tp-tag-skill">Verbal</span>
                        <span className="tp-tag-diff medium">medium</span>
                    </div>
                </div>

                <div className="tp-q-progress">
                    <div className="tp-q-bar"><div className="tp-q-bar-fill" style={{ width: `${progress}%` }} /></div>
                    <p className="tp-caption">{current + 1} / {total}</p>
                </div>
                ...
                <div className="tp-q-footer">
                    <p className="tp-caption">{answeredCount} of {total} answered</p>
