...
export default function Settings() {
    ...
    useEffect(() => {
        fetch(`https://hiresy-orchestrator.onrender.com/linkedin/status/${hrEmail}`)
            .then(r => r.json())
    ...
    const handleConnect = () => {
        window.location.href = `https://hiresy-orchestrator.onrender.com/linkedin/connect?email=${encodeURIComponent(hrEmail)}`;
    };

    const handleDisconnect = async () => {
        setActionMsg("Disconnecting...");
        await fetch(`https://hiresy-orchestrator.onrender.com/linkedin/disconnect/${hrEmail}`, { method: "DELETE" });
