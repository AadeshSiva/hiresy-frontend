...
const ROUND_GROUPS = [
    { title: "Shortlisting Test", sub: ["MCQ Test", "Vibe Coding", "Aptitude / Logical"] },
    { title: "Communication Round", sub: ["Group Discussion", "Verbal Ability Test", "Spoken English Test"] },
...
export default function AddPost() {
    ...
    const handleConnectLinkedIn = () => {
        ...
        window.location.href = `https://hiresy-orchestrator.onrender.com/linkedin/connect?email=${encodeURIComponent(email)}`;
    };
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (platforms.includes("LinkedIn")) {
                ...
                const r = await fetch(`https://hiresy-orchestrator.onrender.com/linkedin/status/${hrEmail}`);
            ...
            const saveRes = await fetch("https://hiresy-orchestrator.onrender.com/jobs", {
            ...
            if (platforms.includes("LinkedIn")) {
                ...
                const liRes = await fetch(`https://hiresy-orchestrator.onrender.com/jobs/${saveData.id}/post-linkedin`, { method: "POST" });
    ...
    // Add this state near the top with other Step 1 states
    const [currentLoc, setCurrentLoc] = useState("Fetching location…");
    const [locLoading, setLocLoading] = useState(false);

    // Add this effect after the state declarations
    useEffect(() => {
        if (!navigator.geolocation) {
            setCurrentLoc("Location unavailable");
            return;
        }
        setLocLoading(true);
        navigator.geolocation.getCurrentPosition(
            async (pos) => {
                try {
                    ...
                    setCurrentLoc([city, state, country].filter(Boolean).join(", "));
                } catch {
                    setCurrentLoc("Location unavailable");
                } finally {
                    setLocLoading(false);
                        ...
                        <div className="ap-col">
                            ...
                            <div className="ap-field">
                                ...
                                <div className="ap-chip-group">
                                    ...
                                    <div className="ap-current-loc">
                                        <IoLocationSharp />
                                        {locLoading ? <span style={{ opacity: 0.6 }}>Detecting…</span> : currentLoc}
                                    </div>
                                </div>
                            </div>
                            <div className="ap-field">
                        ...
                        <div className="ap-col">
                            ...
                            <div className="ap-field">
                                ...
                                <label className="ap-file-label">
                                    ...
                                    <span className="ap-file-btn">📎 Upload Questions</span>
