...
export default function JobPost() {
    ...
    useEffect(() => {
        fetch(`https://hiresy-orchestrator.onrender.com/jobs/${id}`)
    ...
    const ws = job.work_style ? job.work_style.split(",").filter(Boolean) : [];
    const rounds = job.rounds ? job.rounds.split(",").filter(Boolean) : [];
            ...
            <div className="jobpost-content">
                <div className="jobpost-card">
                    ...
                    <div className="jobpost-tags">
                        {ws.map(w => <span key={w} className="jp-tag">{w}</span>)}
                    ...
                    <div className="jobpost-body">
                        ...
                        <div className="jobpost-section">
                            ...
                            <div className="jobpost-detail-grid">
                                ...
                                <div className="jp-detail">
                                    <span className="jp-detail-label">Difficulty</span>
                        ...
                        {rounds.length > 0 && (
                            <div className="jobpost-section">
                                <p className="jobpost-section-title">Interview Process</p>
                                <div className="jobpost-rounds">
                                    {rounds.map((r, i) => (
                                        <div key={r} className="jp-round">
                                            <span className="jp-round-num">{i + 1}</span>
                                            <span>{r}</span>
                                        </div>
                                    ))}
                                </div>
